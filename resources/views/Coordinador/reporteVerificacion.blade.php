                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-footer text-center" id="consolidar">
                                        ...
                                        <a href="{{ url('generar_pdf/'.base64_encode($idPorMat)) }}"
                                           class="btn btn-danger btn-xs" target="_blank">Generar el Portafolio
                                            Consolidado</a>
                            ...
                            <div class="panel panel-primary">
                                ...
                                <div class="panel-body">
                                    @if($paraMat->urlArchivo)
                                        <a title="Visualizar archivo Pdf" href="{{url($paraMat->urlArchivo)}}"
                                ...
                                <div class="panel-footer">
                                    ...
                                    @if($paraMat->urlArchivo)
                                        ...
                                        <a href="javascript:void(0);"
                                           onclick="eliminarArchivoParametroMat('{{$paraMat->id }}')"
                                        ...
                                        <div class="panel panel-primary">
                                            ...
                                            No existe 
                                                ...
                                                @else
                                                    ...
                                                    <a href="javascript:void(0);"
                                                       onclick="eliminarArchivo('{{$paraProd->id }}')"
                                                       title="Eliminar Archivo " class="btn btn-danger"><span
                                                                class="fa fa-trash"></span></a>
