...
<div class="col-md-8"><h4><input required="" name="inicio" id="fechaInicio" type="month" onchange="obtenerFechaInicio()"  class="form-control"> </h4></div>
</div>
    </div>
    ...
    <div class="col-md-5">
     ...
     <h4><label>Fecha Fin<span class="text-danger">*</span> </label></h4>
      ...
      <div class="col-md-8">
        <h4><input type="month" required=""  name="fin" id="fechaFin"  onchange="obtenerFechaFin()" class="form-control"> </h4>
...
<div class="row">
  ...
  <div class="row">
     <div class="col-md-6">
     <h4><input type="hidden" readonly="" name="mes_anio_inicio" id="mes_anio_inicio" class="form-control"></h4>
    </div>
<div class="col-md-6">
     <h4><input type="hidden" readonly="" name="mes_anio_fin" id="mes_anio_fin" class="form-control"></h4>
    </div>
  </div>
