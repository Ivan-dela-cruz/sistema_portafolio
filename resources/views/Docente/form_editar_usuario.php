...
<input type="date" class="form-control"  id="fecha" name="fecha" value="<?=$usuario->fecha_nacimiento?>" required="">
</div>
...
<option value="5">BLANCO/A</option>
        ...
        <div class="form-group col-xs-12">
                              ...
                              <input type="text" class="form-control" id="email" name="email"  readonly  value="<?=$usuario->email;?>">
  ...
  <div class="col-md-6">
      ...
      <form  id="frm_subir_imagen" name="frm_subir_imagen" method="post" action="subir_imagen" class="formarchivo" enctype="multipart/form-data" >
